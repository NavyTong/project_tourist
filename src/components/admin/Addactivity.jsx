      ...
      <div className="w-full max-w-lg bg-white rounded-3xl shadow-xl shadow-blue-900/5 border border-gray-100 overflow-hidden">
        ...
        <div className="bg-blue-600 px-8 py-10 text-white relative overflow-hidden">
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-sm opacity-90">Fill in the details to create a new tourist activity</p>
          </div>
          {/* Decorative circles */}
        ...
        <div className="p-8">
          <form className="space-y-6">
            ...
            <div>
              ...
              <select className="w-full px-5 py-3.5 bg-gray-50 border border-gray-200 rounded-2xl text-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 focus:bg-white transition-all appearance-none">
