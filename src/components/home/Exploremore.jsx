...
export default function Exploremore() {
  ...
  return (
    <section className="px-6 md:px-16 lg:px-24 py-20 bg-slate-50">
      {/* Title */}
      <div className="mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-2">Explore more</h1>
        <p className="text-blue-500 font-semibold tracking-wide uppercase text-sm">Discover all hidden gems</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        {isLoading ? (
          ...
          <Link href={place.href} key={place.name}>
            <div className="group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-xl transition-all duration-500 cursor-pointer border border-gray-100">
              <div className="h-40 overflow-hidden relative">
                ...
                <button 
                  ...
                  className={`absolute top-3 right-3 p-2 rounded-xl backdrop-blur-md border transition-all duration-300 ${
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill={isFavorited(place.id) ? "currentColor" : "none"} viewBox="0 0 24 24" stroke="currentColor">
