...
export default function Kep() {
  const destinations = kepDestinations;
    ...
    <section className="px-8 py-24 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative h-[450px] rounded-[3rem] overflow-hidden mb-24 shadow-2xl group">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Kep_crab_statue.jpg/1280px-Kep_crab_statue.jpg"
            alt="Kep Hero"
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex flex-col justify-center px-16">
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-6 tracking-tighter">Kep</h1>
            ...
            <p className="text-blue-100 text-2xl max-w-lg font-medium italic">"Seafood, Sunsets, and Serenity."</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-32 items-center">
          <div>
            <h2 className="text-blue-500 font-bold tracking-widest uppercase text-sm mb-4">The Saint-Tropez of Southeast Asia</h2>
            <h3 className="text-5xl font-bold text-blue-900 mb-8 tracking-tight">Cambodia's Seaside Charm</h3>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Formerly the premier beach town for the French and Cambodian elite, Kep is 
              experiencing a renaissance. It offers a uniquely quiet and sophisticated 
              coastal experience, marked by the decaying grandeur of its modernist villas.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              Famous globally for its Blue Swimmer Crabs and lush national park, Kep is the 
              perfect destination for travelers looking to indulge in incredible cuisine 
              while escaping the endless noise of the city.
            </p>
          </div>
          <div className="relative h-[450px] rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-gray-50/50">
             <img 
               src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Koh_Tonsay_Beach_-_Cambodia.jpg/1280px-Koh_Tonsay_Beach_-_Cambodia.jpg" 
               alt="Overview" 
        ...
        <div className="mb-32">
          <div className="mb-16 text-center">
             ...
             <p className="text-gray-500 text-lg">Must-visit sites in and around Kep</p>
          </div>
        ...
        <div className="bg-gray-50 rounded-[4rem] p-16 grid grid-cols-1 md:grid-cols-3 gap-12 text-center border border-gray-100">
           <InfoCard 
             ...
             text="November to April is ideal for hitting the beach." 
           />
           <InfoCard 
             icon="ticket" 
             title="Crab Market" 
             text="Head down in the early morning for the best catch." 
           />
           <InfoCard 
             icon="truck" 
             title="Getting Around" 
             text="Rent a scooter to drive up into the National Park." 
           />
        </div>
      </div>
    </section>
