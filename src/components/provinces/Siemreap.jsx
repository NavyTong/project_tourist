    ...
    <section className="px-8 py-24 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative h-[450px] rounded-[3rem] overflow-hidden mb-24 shadow-2xl group">
          <img
            src="/images/provinces/siemreap/hero.png"
            alt="Siem Reap Hero"
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex flex-col justify-center px-16">
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-6 tracking-tighter">Siem Reap</h1>
            ...
            <p className="text-blue-100 text-2xl max-w-lg font-medium italic">"Where Ancient Wonders Breathe and Modernity Thrives."</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-32 items-center">
          <div>
            <h2 className="text-blue-500 font-bold tracking-widest uppercase text-sm mb-4">Temple Town</h2>
            <h3 className="text-5xl font-bold text-blue-900 mb-8 tracking-tight">The Gateway to Angkor</h3>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Siem Reap is Cambodia's premier travel destination, serving as the gateway 
              to the world-famous Angkor Archaeological Park. While the temples are 
              the main draw, the city itself has transformed into a vibrant hub 
              of culture, gastronomy, and hospitality.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              From the bustling markets and nightlife of Pub Street to the 
              serene floating villages on Tonle Sap, Siem Reap offers a unique 
              blend of ancient heritage and modern charm that captivates 
        ...
        <div className="bg-gray-50 rounded-[4rem] p-16 grid grid-cols-1 md:grid-cols-3 gap-12 text-center border border-gray-100">
           <InfoCard 
             ...
             text="November to February offers cool, dry weather." 
           />
           <InfoCard 
             icon="ticket" 
             title="Angkor Pass" 
             text="Available in 1-day, 3-day, and 7-day options." 
           />
           <InfoCard 
             icon="truck" 
             title="Getting Around" 
             text="Tuk-tuks and bikes are common for temple tours." 
           />
        </div>
      </div>
    </section>
