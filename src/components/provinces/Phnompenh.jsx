...
export default function Phnompenh() {
  const destinations = phnompenhDestinations;
    ...
    <section className="px-8 py-24 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative h-[450px] rounded-[3rem] overflow-hidden mb-24 shadow-2xl group">
          <img
            src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Phnom_Penh_skyline_2019.jpg/1280px-Phnom_Penh_skyline_2019.jpg"
            alt="Phnom Penh Hero"
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex flex-col justify-center px-16">
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-6 tracking-tighter">Phnom Penh</h1>
            <div className="flex items-center mb-6">
              <div className="flex text-yellow-500 drop-shadow-md">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} xmlns="http://www.w3.org/2000/svg" className={`h-7 w-7 ${i < Math.floor(4.9) ? 'text-yellow-400' : 'text-gray-400/50'}`} viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                ))}
              </div>
              <span className="text-white text-lg font-bold ml-4 backdrop-blur-md bg-white/20 px-4 py-1.5 rounded-full border border-white/30 shadow-lg">4.9 / 5</span>
            </div>
            <p className="text-blue-100 text-2xl max-w-lg font-medium italic">"The Pearl of Asia, Reborn."</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-32 items-center">
          <div>
            <h2 className="text-blue-500 font-bold tracking-widest uppercase text-sm mb-4">Capital City</h2>
            <h3 className="text-5xl font-bold text-blue-900 mb-8 tracking-tight">The Beating Heart of Cambodia</h3>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Situated at the confluence of the Mekong, Bassac, and Tonle Sap rivers, 
              Phnom Penh is a vibrant bustling capital with a rich, complex history. 
              Once known as the "Pearl of Asia," it is rapidly transforming into a 
              modern metropolis while retaining its colonial charm.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              From the ornate Royal Palace to the poignant historical sites and the 
              lively riverfront promenade, Phnom Penh offers a deeply engaging urban 
          ...
          <div className="relative h-[450px] rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-gray-50/50">
             <img 
               src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Independence_Monument%2C_Phnom_Penh.jpg/1280px-Independence_Monument%2C_Phnom_Penh.jpg" 
               alt="Overview" 
        ...
        <div className="mb-32">
          <div className="mb-16 text-center">
             ...
             <p className="text-gray-500 text-lg">Must-visit sites in the bustling capital</p>
          </div>
        ...
        <div className="bg-gray-50 rounded-[4rem] p-16 grid grid-cols-1 md:grid-cols-3 gap-12 text-center border border-gray-100">
           <InfoCard 
             ...
             text="November to January offers the most pleasant weather." 
           />
           <InfoCard 
             icon="ticket" 
             title="Entry Fees" 
             text="Major museums and palace have $5-$10 entry tickets." 
           />
           <InfoCard 
             icon="truck" 
             title="Getting Around" 
             text="PassApp and Grab tuk-tuks are cheap and ubiquitous." 
           />
        </div>
      </div>
    </section>
