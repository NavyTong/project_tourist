...
export default function Sihanoukville() {
  const destinations = sihanoukvilleDestinations;
    ...
    <section className="px-8 py-24 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative h-[450px] rounded-[3rem] overflow-hidden mb-24 shadow-2xl group">
          <img
            src="https://ak-d.tripcdn.com/images/100i0t000000i8j5l8BC7_C_880_350_R5.jpg"
            alt="Sihanoukville Hero"
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex flex-col justify-center px-16">
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-6 tracking-tighter">Sihanoukville</h1>
            <div className="flex items-center mb-6">
              <div className="flex text-yellow-500 drop-shadow-md">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} xmlns="http://www.w3.org/2000/svg" className={`h-7 w-7 ${i < Math.floor(4.3) ? 'text-yellow-400' : 'text-gray-400/50'}`} viewBox="0 0 20 20" fill="currentColor">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                ))}
              </div>
              <span className="text-white text-lg font-bold ml-4 backdrop-blur-md bg-white/20 px-4 py-1.5 rounded-full border border-white/30 shadow-lg">4.3 / 5</span>
            </div>
            <p className="text-blue-100 text-2xl max-w-lg font-medium italic">"Cambodia's Premier Coastal Escape."</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-32 items-center">
          <div>
            <h2 className="text-blue-500 font-bold tracking-widest uppercase text-sm mb-4">Sun, Sand, and Sea</h2>
            <h3 className="text-5xl font-bold text-blue-900 mb-8 tracking-tight">The Gateway to the Islands</h3>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Sihanoukville, also known as Kampong Som, is Cambodia's premier seaside 
              destination. While the city itself is a bustling deep-water port, its 
              true allure lies in its sequence of sandy beaches and tropical islands.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              From the bustling shores of Ochheuteal to the secluded tranquility of 
              Koh Rong Sanloem, Sihanoukville provides the perfect tropical bookend 
              to the ancient temples of the north. Whether you dive, party, or simply 
              lounge, the coast awaits.
            </p>
          </div>
          <div className="relative h-[450px] rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-gray-50/50">
             <img 
               src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Koh_Rong_Sanloem.jpg/1280px-Koh_Rong_Sanloem.jpg" 
               alt="Overview" 
        ...
        <div className="mb-32">
          <div className="mb-16 text-center">
             ...
             <p className="text-gray-500 text-lg">Must-visit beaches and islands</p>
          </div>
        ...
        <div className="bg-gray-50 rounded-[4rem] p-16 grid grid-cols-1 md:grid-cols-3 gap-12 text-center border border-gray-100">
           <InfoCard 
             ...
             text="November to April offers the calmest seas and clearest skies." 
           />
           <InfoCard 
             icon="ticket" 
             title="Island Ferries" 
             text="Speedboats depart from Serendipity Pier multiple times daily." 
           />
           <InfoCard 
             icon="truck" 
             title="Getting Around" 
             text="Tuk-tuks are plentiful; negotiate prices before getting in." 
           />
        </div>
      </div>
    </section>
