...
export default function Kohkong() {
  const destinations = kohkongDestinations;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative h-[450px] rounded-[3rem] overflow-hidden mb-24 shadow-2xl group">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex flex-col justify-center px-16">
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-6 tracking-tighter">Koh Kong</h1>
            ...
            <p className="text-blue-100 text-2xl max-w-lg font-medium italic">"Where the Jungle Greets the Sea."</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-32 items-center">
          <div>
            <h2 className="text-blue-500 font-bold tracking-widest uppercase text-sm mb-4">The Wild Frontier</h2>
            <h3 className="text-5xl font-bold text-blue-900 mb-8 tracking-tight">Cambodia's Eco-Tourism Hub</h3>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Koh Kong is a province of extraordinary natural beauty, dominated by the 
              dense, mysterious Cardamom Mountains and fringed by pristine, untouched 
              coastline along the Gulf of Thailand.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              Once largely inaccessible, it has rapidly become Cambodia's premier destination 
              for eco-tourism. From trekking through vast mangrove forests to relaxing on 
              island beaches with crystalline waters, Koh Kong is an adventurer's dream.
            </p>
          </div>
          <div className="relative h-[450px] rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-gray-50/50">
             <img 
               src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/1d/Koh_Kong_bridge.jpg/1280px-Koh_Kong_bridge.jpg" 
               alt="Overview" 
        ...
        <div className="mb-32">
          <div className="mb-16 text-center">
             ...
             <p className="text-gray-500 text-lg">Must-visit sites in and around Koh Kong</p>
          </div>
        ...
        <div className="bg-gray-50 rounded-[4rem] p-16 grid grid-cols-1 md:grid-cols-3 gap-12 text-center border border-gray-100">
           <InfoCard 
             ...
             text="November to February provides cool, dry weather for trekking." 
           />
           <InfoCard 
             icon="ticket" 
             title="Eco-Tours" 
             text="Book local community-based tours to support the region." 
           />
           <InfoCard 
             icon="truck" 
             title="Getting Around" 
             text="Motorbikes are essential for exploring beyond the main town." 
           />
        </div>
      </div>
    </section>
