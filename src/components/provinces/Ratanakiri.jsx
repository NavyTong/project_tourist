...
export default function Ratanakiri() {
  const destinations = ratanakiriDestinations;
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative h-[450px] rounded-[3rem] overflow-hidden mb-24 shadow-2xl group">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/60 to-transparent flex flex-col justify-center px-16">
            <h1 className="text-6xl md:text-8xl font-bold text-white mb-6 tracking-tighter">Ratanakiri</h1>
            ...
            <p className="text-blue-100 text-2xl max-w-lg font-medium italic">"The Wild, Untamed Northeast."</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 mb-32 items-center">
          <div>
            <h2 className="text-blue-500 font-bold tracking-widest uppercase text-sm mb-4">The Final Frontier</h2>
            <h3 className="text-5xl font-bold text-blue-900 mb-8 tracking-tight">Crater Lakes and Jungle Treks</h3>
            <p className="text-gray-600 text-lg leading-relaxed mb-6">
              Ratanakiri is Cambodia's most remote and rugged province. It is a land 
              of deep red earth, spectacular crater lakes, and vast, unexplored 
              tracts of virgin jungle stretching to the borders of Vietnam and Laos.
            </p>
            <p className="text-gray-600 text-lg leading-relaxed">
              For the adventurous traveler, Ratanakiri offers unparalleled opportunities 
              for deep jungle trekking in Virachey National Park, refreshing swims 
              in the pristine waters of Yeak Laom lake, and culturally immersive visits 
              with the diverse indigenous hill tribes.
            </p>
          </div>
          <div className="relative h-[450px] rounded-[2.5rem] overflow-hidden shadow-2xl border-8 border-gray-50/50">
             <img 
               src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Yeak_Laom_Lake_-_Banlung_-_Cambodia.jpg/1280px-Yeak_Laom_Lake_-_Banlung_-_Cambodia.jpg" 
               alt="Overview" 
        ...
        <div className="mb-32">
          <div className="mb-16 text-center">
             ...
             <p className="text-gray-500 text-lg">Must-visit sites in the rugged northeast</p>
          </div>
        ...
        <div className="bg-gray-50 rounded-[4rem] p-16 grid grid-cols-1 md:grid-cols-3 gap-12 text-center border border-gray-100">
           <InfoCard 
             ...
             text="November to February for cooler trekking conditions." 
           />
           <InfoCard 
             icon="ticket" 
             title="Park Entry" 
             text="Virachey requires permits and mandatory local guides." 
           />
           <InfoCard 
             icon="truck" 
             title="Getting Around" 
             text="Banlung is the base; organize all treks and transport here." 
           />
        </div>
      </div>
    </section>
